...
<div class="table-responsive">
	 <table class="table table-hover table-condensed table-bordered" style="text-align: center;">
	 	<caption><h2 style="color:black"><center><b>Clientes Existentes</center></h2></caption>
	 	<tr>
	 		<td style="color:blue" ><b>Nombre</td>
	 		<td style="color:blue" ><b>Apellido</td>
	 		<td style="color:blue" ><b>Direccion</td>
	 		<td style="color:blue" ><b>Email</td>
	 		<td style="color:blue" ><b>Telefono</td>
	 		<td style="color:blue" ><b>DUI</td>
